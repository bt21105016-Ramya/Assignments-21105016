...
i=0
#define dictionary to store element, counter pairs and eliminating common occurences
dict={}
...
while condition:
    if prompt.lower()=="y":
        ...
        Dictionary[SID]=name
        prompt= input("If you want to enter other details press Y/N- ")
        condition = True
    else:
        condition = False
print("Part a")
...
#Question 7
print("Question 7")
number=int(input("Total elements of Fibonacci sequence (must be greater than 4)- "))
...
print(f"set of all elements that are in Set1 and Set2 but not both. {set_notboth}")
#Finding symmetric difference of all sets
print("Part b")
set_onlyinone=Set1^Set2^Set3
print(f"Set of all elements that are in only one of the three sets Set1, Set2 and Set3. {set_onlyinone}")
#Finding elements that is common in any two sets
print("Part C")
set_onlyintwo=(Set1|Set2|Set3)- (Set1^Set2^Set3)-(Set1&Set2&Set3)
print(f"Set of elements that are only in only one of the three sets Set1, Set2 and Set3. {set_onlyintwo}")
...
print(f"set of all integers in the range 1 to 10 that are not in Set1, Set2 and Set3. {not_common_2}")
        column=column+1
    print("")